...
<header>
  ...
  <label>预览模式 <select id="mode"><option value="hud">主 HUD / 窗口组合</option><option value="map-candidate">完整地图资源候选 / FMMap F0</option><option value="secondary-0">角色选择/创建候选 A</option><option value="secondary-1">角色选择候选 B</option></select></label>
