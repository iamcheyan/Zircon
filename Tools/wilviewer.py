...
let DATA = null; let SCREEN_MODE='hud'; let DIFF_URL=''; const key='mir3_evidence_ui_state';
function state(){ try{return JSON.parse(localStorage.getItem(key)||'{}')}catch(e){return {}} }
function save(){localStorage.setItem(key,JSON.stringify({debug:$('#debug').checked,frames:$('#frames').checked,mode:SCREEN_MODE,diffShow:$('#diff-show').checked,diffOpacity:$('#diff-opacity').value}));}
