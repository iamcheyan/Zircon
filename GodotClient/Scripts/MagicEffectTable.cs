...
public static class MagicEffectTable
{
    ...
    private static readonly Dictionary<MagicType, CastEffect> _table = new()
    {
        ...
        [MagicType.Cyclone] = new CastEffect { File = LibraryFile.MagicEx, StartIndex = 1990, FrameCount = 5, Colour = Wind, Source = new ImpactDef { File = LibraryFile.MagicEx, StartIndex = 1970, FrameCount = 10, DelayMs = 60, Colour = Wind }, MapImpact = new ImpactDef { File = LibraryFile.MagicEx, StartIndex = 1990, FrameCount = 5, Colour = Wind }, TargetEffect = new ImpactDef { File = LibraryFile.MagicEx, StartIndex = 1970, FrameCount = 10, DelayMs = 60, Colour = Wind }, Additional = { new ImpactDef { File = LibraryFile.MagicEx, StartIndex = 2000, FrameCount = 8, StartDelayMs = 500, Colour = Wind } } },
