...
public sealed partial class KeyBindDialog : DXWindow
{
    ...
    public KeyBindDialog()
    {
        ...
        AddControl(close);
        AddControl(new DXLabel { Text = "Select an entry and press a key to change it. Escape restores the current key.", FontSize = 9, Location = new Vector2I(18, 39), Size = new Vector2I(410, 18), IsControl = false });
